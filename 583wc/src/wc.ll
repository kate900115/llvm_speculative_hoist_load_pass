...
land.lhs.true:                                    ; preds = %do.body
  ...
  %arrayidx9 = getelementptr inbounds i8** %16, i64 %idxprom
  %17 = load i8** %arrayidx9, align 8
  %call10 = call %struct._IO_FILE* @fopen(i8* %17, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx14 = getelementptr inbounds i8** %19, i64 %idxprom13
  %20 = load i8** %arrayidx14, align 8
...
for.cond:                                         ; preds = %if.end70, %if.then68, %if.end46, %if.end
  %21 = load i32* @bufcurrent, align 4
  %22 = load i32* @bufcount, align 4
...
cond.true:                                        ; preds = %for.cond
  ...
  %24 = load i32* @bufcurrent, align 4
...
cond.false:                                       ; preds = %for.cond
  %26 = load i32* @bufcurrent, align 4
...
if.end27:                                         ; preds = %cond.end
  %29 = load i64* @charct, align 8
  %inc28 = add nsw i64 %29, 1
  store i64 %inc28, i64* @charct, align 8
  %30 = load i64* @last_charct, align 8
...
for.end:                                          ; preds = %if.then26
  %50 = load i8** @wd, align 8
  %51 = load i64* @charct, align 8
  %52 = load i64* @wordct, align 8
  %53 = load i64* @linect, align 8
  call void @wcp(i8* %50, i64 %51, i64 %52, i64 %53, i64* getelementptr inbounds ([25 x i64]* @wordct_array, i32 0, i32 0))
  %54 = load i32* %argc.addr, align 4
...
if.then73:                                        ; preds = %for.end
  ...
  %arrayidx75 = getelementptr inbounds i8** %56, i64 %idxprom74
  %57 = load i8** %arrayidx75, align 8
  %call76 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i8* %57)
  br label %if.end79
...
if.end79:                                         ; preds = %if.else77, %if.then73
  ...
  %59 = load i64* @linect, align 8
  %60 = load i64* @tlinect, align 8
  %add = add nsw i64 %60, %59
  store i64 %add, i64* @tlinect, align 8
  %61 = load i64* @wordct, align 8
  %62 = load i64* @twordct, align 8
  %add81 = add nsw i64 %62, %61
  store i64 %add81, i64* @twordct, align 8
  %63 = load i64* @charct, align 8
  %64 = load i64* @tcharct, align 8
...
if.then88:                                        ; preds = %do.end
  %68 = load i8** @wd, align 8
  %69 = load i64* @tcharct, align 8
  %70 = load i64* @twordct, align 8
  %71 = load i64* @tlinect, align 8
  call void @wcp(i8* %68, i64 %69, i64 %70, i64 %71, i64* getelementptr inbounds ([25 x i64]* @wordct_array, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i32 %2 to i64
  %3 = load i64** %wordct_array.addr, align 8
  %arrayidx = getelementptr inbounds i64* %3, i64 %idxprom
  %4 = load i64* %arrayidx, align 8
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str7, i32 0, i32 0), i32 %1, i64 %4)
  br label %for.inc
...
while.cond:                                       ; preds = %sw.epilog, %for.end
  %6 = load i8** %wd.addr, align 8
  %7 = load i8* %6, align 1
  %tobool = icmp ne i8 %7, 0
  br i1 %tobool, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %8 = load i8** %wd.addr, align 8
...
sw.bb:                                            ; preds = %while.body
  %10 = load i64* %linect.addr, align 8
  call void @ipr(i64 %10)
  br label %sw.epilog

sw.bb2:                                           ; preds = %while.body
  %11 = load i64* %wordct.addr, align 8
  call void @ipr(i64 %11)
  br label %sw.epilog

sw.bb3:                                           ; preds = %while.body
  %12 = load i64* %charct.addr, align 8
